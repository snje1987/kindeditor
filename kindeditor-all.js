...
var _VERSION = '4.1.12 (2017-12-27)',
...
KindEditor.lang({
    ...
    'bigfile.startUpload': '开始上传',
    'bigfile.selectUpload': '选择文件',
    'bigfile.clearAll': '清空',
    'bigfile.insertAll': '完成',
    'bigfile.pending': '等待上传',
    'bigfile.uploadError': '上传失败',
    'bigfile.uploading': '上传中',
    'bigfile.checking': '校验中',
    'bigfile.succeed': '上传成功',
...
KindEditor.plugin('filemanager', function (K) {
    ...
    self.plugin.filemanagerDialog = function (options) {
        ...
        function bindEvent(el, result, data, createFunc) {
            var fileUrl = K.formatUrl(data.fileUrl, 'absolute'),
        ...
        function bindEventDel(el, result, data, createFunc) {
        ...
        function createView(result) {
            ...
            for (var i = 0, len = fileList.length; i < len; i++) {
                ...
                if (!data.is_dir || data.has_file) {
                    ...
                    bindEvent(img, result, data, createView);
                } else {
